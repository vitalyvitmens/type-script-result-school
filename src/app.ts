...
//! Использование сторонних библиотек. Файлы декларации
/* Если при установке npm пакета с сайта https://www.npmjs.com/ напротив названия пакета мы видим значёк: 
- DT, это значит типизация есть, но ее нужно установить отдельно, кликнув на значёк перейдем в другой пакет с типизацией его и устанавливаем
- TS, это значит пакет уже из коробки типизирован
- если значка вовсе нет, это значит что пакет придется типизировать самим, для этого проедлаем следующие шаги:
  - npm init -y (инициализируем файл package.json)
  - в папке src создаем файл декларации src\types.d.ts
  - устанавливаем пакет не имеющий типизации, например npm i chroma-js 
  - самомстоятельно описываем типизацию пакета в файле декларации types.d.ts
*/
